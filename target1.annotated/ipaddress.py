...
def _compat_to_bytes(intval: Union[builtins.int, builtins.bool], length: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict], endianess: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]):
...
def _compat_range(start, end, step: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]=1):
    assert step > 0
    i = start
    while i < end:
        yield i
...
def _count_righthand_zero_bits(number: Union[builtins.int, builtins.bool], bits):
...
def summarize_address_range(first: Union[IPv4Address, IPv4Interface, IPv6Address, IPv6Interface], last: Union[IPv4Address, IPv4Interface, IPv6Address, IPv6Interface]):
...
def collapse_addresses(addresses: Union[builtins.str, _BaseNetwork, IPv4Network, IPv6Network, builtins.str, builtins.list, builtins.dict]):
...
class _IPAddressBase(_TotalOrderingMixin):
    ...
    def _check_int_address(self, address: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]):
        if address < 0:
    ...
    def _check_packed_address(self, address: Union[builtins.str, builtins.str, builtins.list, builtins.dict], expected_len):
    ...
    @classmethod
    def _ip_int_from_prefix(cls: Union[_BaseV4, IPv4Address, IPv4Interface, IPv4Network, _BaseV6, IPv6Address, IPv6Interface, IPv6Network], prefixlen):
    ...
    @classmethod
    def _prefix_from_ip_int(cls: Union[_BaseV4, IPv4Address, IPv4Interface, IPv4Network, _BaseV6, IPv6Address, IPv6Interface, IPv6Network], ip_int: Union[builtins.int, builtins.bool]):
    ...
    @classmethod
    def _prefix_from_prefix_string(cls: Union[IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network], prefixlen_str):
    ...
    @classmethod
    def _prefix_from_ip_string(cls: Union[_BaseV4, IPv4Address, IPv4Interface, IPv4Network, _BaseV6, IPv6Address, IPv6Interface, IPv6Network], ip_str):
...
class _BaseNetwork(_IPAddressBase):
    ...
    def __getitem__(self, n: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]):
        network = int(self.network_address)
        broadcast = int(self.broadcast_address)
        if n >= 0:
    ...
    def __contains__(self, other: Union[IPv4Address, IPv4Interface, IPv6Address, IPv6Interface]):
        if self._version != other._version:
            return False
    ...
    def overlaps(self, other: Union[IPv4Network, IPv6Network]):
    ...
    def subnets(self, prefixlen_diff: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]=1, new_prefix=None):
    ...
    def supernet(self, prefixlen_diff: Union[builtins.str, _TotalOrderingMixin, _IPAddressBase, _BaseAddress, _BaseNetwork, IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]=1, new_prefix=None):
    ...
    @staticmethod
    def _is_subnet_of(a: Union[_BaseV4, IPv4Address, IPv4Interface, IPv4Network, _BaseV6, IPv6Address, IPv6Interface, IPv6Network], b: Union[_BaseV4, IPv4Address, IPv4Interface, IPv4Network, _BaseV6, IPv6Address, IPv6Interface, IPv6Network]):
        try:
...
class _BaseV4(object):
    ...
    @classmethod
    def _make_netmask(cls: Union[IPv4Address, IPv4Interface, IPv4Network, IPv6Address, IPv6Interface, IPv6Network], arg: Union[builtins.str, _BaseNetwork, IPv4Network, IPv6Network, builtins.str, builtins.list, builtins.dict]):
    ...
    @classmethod
    def _parse_octet(cls: Union[_BaseV4, IPv4Address, IPv4Interface, IPv4Network], octet_str):
    ...
    def _is_hostmask(self, ip_str: Union[builtins.str, builtins.str]):
...
class IPv4Interface(IPv4Address):
    ...
    def __init__(self, address: Union[builtins.str, builtins.str, builtins.list, builtins.dict]):
...
class IPv4Network(_BaseV4, _BaseNetwork):
    ...
    def __init__(self, address: Union[builtins.str, builtins.str, builtins.list, builtins.dict], strict=True):
...
class _BaseV6(object):
    ...
    @classmethod
    def _ip_int_from_string(cls: Union[_BaseV6, IPv6Address, IPv6Interface, IPv6Network], ip_str):
    ...
    @classmethod
    def _parse_hextet(cls: Union[_BaseV6, IPv6Address, IPv6Interface, IPv6Network], hextet_str):
    ...
    @classmethod
    def _compress_hextets(cls, hextets: Union[builtins.str, builtins.str, builtins.list, builtins.dict]):
    ...
    @classmethod
    def _string_from_ip_int(cls: Union[IPv6Address, IPv6Interface], ip_int=None):
