...
def _cmp(x: Union[datetime.timedelta, datetime.date, datetime.time, datetime.datetime, datetime.timezone++, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict], y):
...
def _is_leap(year: Union[datetime.timedelta, builtins.int, builtins.str, builtins.float, builtins.bool]):
    """year -> 1 if leap year, else 0."""
    return year % 4 == 0 and (year % 100 != 0 or year % 400 == 0)

def _days_before_year(year: Union[datetime.timedelta, datetime.date, datetime.datetime, builtins.int, builtins.float, builtins.bool]):
    """year -> number of days before January 1st of year."""
    y = year - 1
    return y * 365 + y // 4 - y // 100 + y // 400

def _days_in_month(year, month: Union[datetime.timedelta, datetime.date, datetime.time, datetime.datetime, datetime.timezone, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]):
...
def _days_before_month(year, month: Union[datetime.timedelta, datetime.date, datetime.time, datetime.datetime, datetime.timezone, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]):
...
def _format_time(hh, mm, ss, us, timespec: Union[datetime.timedelta, datetime.date, datetime.time, datetime.datetime, datetime.timezone, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]='auto'):
...
def _wrap_strftime(object: Union[datetime.tzinfo, datetime.time, datetime.datetime, datetime.timezone], format: Union[builtins.str, builtins.list, builtins.dict], timetuple):
    freplace = None
    zreplace = None
    Zreplace = None
    newformat = []
...
def _parse_isoformat_date(dtstr: Union[builtins.str, builtins.list, builtins.dict]):
    year = int(dtstr[0:4])
    if dtstr[4] != '-':
...
def _parse_hh_mm_ss_ff(tstr: Union[builtins.str, builtins.list, builtins.dict]):
    len_str = len(tstr)
    time_comps = [0, 0, 0, 0]
    pos = 0
...
def _parse_isoformat_time(tstr: Union[builtins.str,]):
    len_str = len(tstr)
    if len_str < 2:
...
def _check_utc_offset(name: Union[builtins.str, builtins.list, builtins.dict], offset):
...
def _check_time_fields(hour, minute, second, microsecond, fold: Union[builtins.str, builtins.list, builtins.dict]):
    hour = _index(hour)
...
def _divide_and_round(a, b: Union[datetime.timedelta, datetime.date, datetime.time, datetime.datetime, datetime.timezone, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]):
...
class timedelta:
    ...
    def __new__(cls, days: Union[builtins.int, builtins.float, builtins.bool]=0, seconds: Union[builtins.int, builtins.float, builtins.bool]=0, microseconds: Union[datetime.timedelta, datetime.date, datetime.datetime, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list]=0, milliseconds: Union[datetime.timedelta, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list]=0, minutes: Union[datetime.timedelta, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list]=0, hours: Union[datetime.timedelta, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list]=0, weeks: Union[datetime.timedelta, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list]=0):
        d = s = us = 0
        days += weeks * 7
    ...
    def __mul__(self, other: Union[builtins.int, builtins.float, builtins.bool]):
...
class date:
    ...
    def __new__(cls, year: Union[builtins.str, builtins.list, builtins.dict], month=None, day=None):
        """Constructor.
        Arguments:
    ...
    @classmethod
    def today(cls: Union[datetime.date, datetime.datetime]):
    ...
    @classmethod
    def fromisocalendar(cls, year, week: Union[datetime.timedelta, datetime.date, datetime.datetime, builtins.int, builtins.float, builtins.bool], day: Union[datetime.timedelta, datetime.date, datetime.datetime, builtins.int, builtins.float, builtins.bool]):
    ...
    def __format__(self, fmt: Union[builtins.str, builtins.list, builtins.dict]):
    ...
    def __add__(self, other: Union[datetime.timedelta,]):
...
class tzinfo:
    ...
    def fromutc(self, dt: Union[datetime.time, datetime.datetime]):
...
class time:
    ...
    def __new__(cls, hour: Union[builtins.str, builtins.list, builtins.dict]=0, minute=0, second=0, microsecond=0, tzinfo=None, *, fold=0):
        """Constructor.
        Arguments:
    ...
    def _getstate(self, protocol: Union[datetime.timedelta, datetime.date, datetime.time, datetime.datetime, datetime.timezone, builtins.int, builtins.str, builtins.float, builtins.bool, builtins.list, builtins.dict]=3):
...
class datetime(date):
    ...
    def __new__(cls, year: Union[builtins.str, builtins.list, builtins.dict], month=None, day=None, hour=0, minute=0, second=0, microsecond=0, tzinfo=None, *, fold=0):
    ...
    @classmethod
    def _fromtimestamp(cls, t: Union[datetime.timedelta, datetime.date, datetime.datetime, builtins.int, builtins.float, builtins.bool], utc, tz):
    ...
    @classmethod
    def now(cls: Union[datetime.date, datetime.datetime], tz=None):
    ...
    @classmethod
    def combine(cls, date: Union[datetime.date, datetime.datetime], time: Union[datetime.time, datetime.datetime], tzinfo=True):
    ...
    @classmethod
    def fromisoformat(cls, date_string: Union[builtins.str, builtins.list, builtins.dict]):
...
class timezone(tzinfo):
    ...
    def __repr__(self):
        ...
        if self._name is None:
            return '%s.%s(%r)' % (self.__class__.__module__, self.__class__.__qualname__, self._offset)
    ...
    def fromutc(self, dt: Union[datetime.datetime,]):
