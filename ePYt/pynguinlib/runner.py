...
class Pynguin(object):
    ...
    def __init__(self, algorithm: Algorithm, project_path: str,
                 output_path: str, ):
        self.algorithm = algorithm
        self.project_path = project_path
        self.output_path = output_path

    def run_pynguin(self, algorithm: Algorithm, project_path: str,
                    output_path: str, module_name: str) -> ReturnCode:
        configuration = Configuration(
            algorithm=algorithm, project_path=project_path,
            output_path=output_path, module_name=module_name)
        set_configuration(configuration)
        return pynguin.run_pynguin().value

    def spawn_pynguin(self, algorithm: Algorithm, project_path: str,
                      output_path: str, module_name: str,
    ...
    def run(self, module_name: str,
        ...
        if spawn:
            return self.spawn_pynguin(algorithm, project_path, output_path,
                                      module_name, capture_output)
        return self.run_pynguin(algorithm, project_path, output_path,
                                module_name)
